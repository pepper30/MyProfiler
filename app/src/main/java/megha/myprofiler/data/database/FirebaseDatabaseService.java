    ...
    public Completable uploadImage(final Profile profile) {
        return Completable.create(new CompletableOnSubscribe() {
            ...
            public void subscribe(final CompletableEmitter e) throws Exception {
                ...
                StorageReference storageRef = storage.getReferenceFromUrl("gs://myprofiler-9746f.appspot.com/").child(profile.getUid());
    ...
    public Maybe<String> downloadUrl(final User user) {
        return Maybe.create(new MaybeOnSubscribe<String>() {
            ...
            public void subscribe(@io.reactivex.annotations.NonNull final MaybeEmitter<String> e) throws Exception {
                FirebaseStorage storage = FirebaseStorage.getInstance();
                StorageReference storageReference = storage.getReferenceFromUrl("gs://myprofiler-9746f.appspot.com").child(user.getUserId());
